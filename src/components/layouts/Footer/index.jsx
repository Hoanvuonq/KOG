...
const Footer = () => {
    return (
        <div className="flex justify-between px-10 border-t border-[#482C27 w-full h-20 mt-[78px] py-4 px-[60px] items-center shadow-lg backdrop-blur-md">
            <p className="text-footer text-black">$Nothing © 2023. ALL RIGHTS RESERVED</p>

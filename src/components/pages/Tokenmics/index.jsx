    ...
    return (
        <>
            <div className="all-center flex-col">
                ...
                <div className="all-center gap-20 lg:flex-row flex-col">
                    <div className="all-center flex-col">
                        ...
                        <Link to={'/'}>
                            <button className="text-token text-white py-5 px-10 rounded-xl w-[400px] h-[57px] shadow-custom  all-center border-4 border-white">
            ...
            <div className="all-center flex-col mt-20">
                <Link to={'/'}>
                    <button className="text-token text-white sm:py-5 py-8 px-10 rounded-xl sm:w-[413px] w-[400px] h-[57px] shadow-custom  all-center border-4 border-white">
                        Ownership Renounced
                    </button>
                </Link>
            </div>

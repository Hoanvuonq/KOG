        ...
        <div className="bg-kog w-full h-full">  
            <div className="bg-[#01010178] w-full h-full flex flex-col justify-between">
                <div className="all-center w-full pt-[20px] flex-col">
                    ...
                    <p className="text-content text-white text-center sm:!text-base !text-xl max-w[80%] overflow-hidden text-ellipsis">CA : 0xc7A320CA7606770ce6360cec380435057C687065</p>

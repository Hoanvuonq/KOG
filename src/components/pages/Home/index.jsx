...
import Avatar from "../../../assets/avatar-test.png" 
import Meet from "../Meet";
import Footer from "../../layouts/Footer";
import Missor from "../../layouts/MissorDesign";
        ...
        <Missor/>
            <div className="w-full h-full relative z-20">
                <div className="all-center w-full pt-[100px] flex-col">
                    ...
                    <h1 className="text-title text-black text-s sm:!text-[100px] !text-[80px] with-shadow">$MISSOR</h1>
                    <p className="text-content text-black text-s text-center sm:px-0 px-2">CA :</p>
                    <p className="text-content text-black text-s text-center sm:px-0 px-2">The Missor Impossible - $MISSOR</p>

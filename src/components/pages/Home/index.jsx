        ...
        <div className="bg-kog w-full h-full">  
            <div className="bg-custom w-full h-full">
                <div className="all-center w-full pt-[100px] flex-col">
                    ...
                    <h1 className="text-title text-white text-s sm:!text-[100px] !text-[80px] with-shadow">PEPIE</h1>
                    <p className="text-content text-white text-s text-center sm:px-0 px-2">CA :</p>
                    <p className="text-content text-white text-s text-center sm:px-0 px-2">PEPIE THE ZOMBIE</p>
